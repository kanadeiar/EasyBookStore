...
namespace EasyBookStore.Models.Data
{
    public class StaticData
    {
        ...
        {
            new Product { Id = 1, Name = "Гарри поттер 1", Price = 500, ImageUrl = "harrypotter1.png", Order = 0, AuthorId = 1, GenreId = 3 },
            new Product { Id = 2, Name = "Гарри поттер 2", Price = 450, ImageUrl = "harrypotter1.png", Order = 1, AuthorId = 1, GenreId = 3 },
            new Product { Id = 3, Name = "Гарри поттер 3", Price = 800, ImageUrl = "harrypotter1.png", Order = 2, AuthorId = 1, GenreId = 3 },
            new Product { Id = 4, Name = "Властелин колец 1", Price = 600, ImageUrl = "harrypotter1.png", Order = 3, AuthorId = 2, GenreId = 4 },
            new Product { Id = 5, Name = "Властелин колец 2", Price = 790, ImageUrl = "harrypotter1.png", Order = 4, AuthorId = 2, GenreId = 4 },
            new Product { Id = 6, Name = "Властелин колец 3", Price = 400, ImageUrl = "harrypotter1.png", Order = 5, AuthorId = 2, GenreId = 4 },
            new Product { Id = 7, Name = "Путешествие по миру", Price = 510, ImageUrl = "harrypotter1.png", Order = 6, AuthorId = 3, GenreId = 10 },
            new Product { Id = 8, Name = "Гении и трусы", Price = 400, ImageUrl = "harrypotter1.png", Order = 7, AuthorId = 4, GenreId = 6 },
            new Product { Id = 9, Name = "Синяя книга", Price = 790, ImageUrl = "harrypotter1.png", Order = 8, AuthorId = 4, GenreId = 6 },
            new Product { Id = 10, Name = "Триумф в сортире", Price = 920, ImageUrl = "harrypotter1.png", Order = 9, AuthorId = 5, GenreId = 6 },
            new Product { Id = 11, Name = "Терминатор 1", Price = 300, ImageUrl = "harrypotter1.png", Order = 10, AuthorId = 6, GenreId = 3 },
            new Product { Id = 12, Name = "Терминатор 2", Price = 750, ImageUrl = "harrypotter1.png", Order = 11, AuthorId = 6, GenreId = 3 },
            new Product { Id = 13, Name = "Терминатор 3", Price = 800, ImageUrl = "harrypotter1.png", Order = 12, AuthorId = 6, GenreId = 3 },
            new Product { Id = 14, Name = "Буржуазия 1", Price = 700, ImageUrl = "harrypotter1.png", Order = 13, AuthorId = 7, GenreId = 7 },
            new Product { Id = 15, Name = "Буржуазия 2", Price = 990, ImageUrl = "harrypotter1.png", Order = 14, AuthorId = 7, GenreId = 7 },
            new Product { Id = 16, Name = "Буржуи", Price = 1400, ImageUrl = "harrypotter1.png", Order = 15, AuthorId = 8, GenreId = 2 },
            new Product { Id = 17, Name = "Филькина грамота", Price = 910, ImageUrl = "harrypotter1.png", Order = 16, AuthorId = 9, GenreId = 5 },
            new Product { Id = 18, Name = "Компьютерные вирусы", Price = 900, ImageUrl = "harrypotter1.png", Order = 17, AuthorId = 10, GenreId = 12 },
            new Product { Id = 19, Name = "Шесть соток", Price = 1190, ImageUrl = "harrypotter1.png", Order = 18, AuthorId = 9, GenreId = 23 },
            new Product { Id = 20, Name = "Сказки на ночь", Price = 1220, ImageUrl = "harrypotter1.png", Order = 19, AuthorId = 10, GenreId = 25 },
        };
    }
}
