...
namespace EasyBookStore.Models.Data
{
    public class StaticData
    {
        ...
        public static List<Product> Products { get; } = new()
        {
            ...
            new Product { Id = 3, Name = "Гарри поттер 3", Price = 800, ImageUrl = "harrypotter1.png", Message = "Книга о Гарри поттере первая из всего цикла рассказывает о фантастике.", Order = 2, AuthorId = 1, GenreId = 3 },
            ...
            new Product { Id = 5, Name = "Властелин колец 2", Price = 790, ImageUrl = "harrypotter1.png", Message = "Книга о Гарри поттере первая из всего цикла рассказывает о фантастике.", Order = 4, AuthorId = 2, GenreId = 4 },
            new Product { Id = 6, Name = "Властелин колец 3", Price = 400, ImageUrl = "harrypotter1.png", Message = "Книга о Гарри поттере первая из всего цикла рассказывает о фантастике.", Order = 5, AuthorId = 2, GenreId = 4 },
            ...
            new Product { Id = 8, Name = "Гении и трусы", Price = 400, ImageUrl = "harrypotter1.png", Message = "Книга о Гарри поттере первая из всего цикла рассказывает о фантастике.", Order = 7, AuthorId = 4, GenreId = 6 },
            new Product { Id = 9, Name = "Синяя книга", Price = 790, ImageUrl = "harrypotter1.png", Message = "Книга о Гарри поттере первая из всего цикла рассказывает о фантастике.", Order = 8, AuthorId = 4, GenreId = 6 },
            new Product { Id = 10, Name = "Триумф в сортире", Price = 920, ImageUrl = "harrypotter1.png", Message = "Книга о Гарри поттере первая из всего цикла рассказывает о фантастике.", Order = 9, AuthorId = 5, GenreId = 6 },
            new Product { Id = 11, Name = "Терминатор 1", Price = 300, ImageUrl = "harrypotter1.png", Message = "Книга о Гарри поттере первая из всего цикла рассказывает о фантастике.", Order = 10, AuthorId = 6, GenreId = 3 },
            new Product { Id = 12, Name = "Терминатор 2", Price = 750, ImageUrl = "harrypotter1.png", Message = "Книга о Гарри поттере первая из всего цикла рассказывает о фантастике.", Order = 11, AuthorId = 6, GenreId = 3 },
            new Product { Id = 13, Name = "Терминатор 3", Price = 800, ImageUrl = "harrypotter1.png", Message = "Книга о Гарри поттере первая из всего цикла рассказывает о фантастике.", Order = 12, AuthorId = 6, GenreId = 3 },
            new Product { Id = 14, Name = "Буржуазия 1", Price = 700, ImageUrl = "harrypotter1.png", Message = "Книга о Гарри поттере первая из всего цикла рассказывает о фантастике.", Order = 13, AuthorId = 7, GenreId = 7 },
            new Product { Id = 15, Name = "Буржуазия 2", Price = 990, ImageUrl = "harrypotter1.png", Message = "Книга о Гарри поттере первая из всего цикла рассказывает о фантастике.", Order = 14, AuthorId = 7, GenreId = 7 },
            new Product { Id = 16, Name = "Буржуи", Price = 1400, ImageUrl = "harrypotter1.png", Message = "Книга о Гарри поттере первая из всего цикла рассказывает о фантастике.", Order = 15, AuthorId = 8, GenreId = 2 },
            new Product { Id = 17, Name = "Филькина грамота", Price = 910, ImageUrl = "harrypotter1.png", Message = "Книга о Гарри поттере первая из всего цикла рассказывает о фантастике.", Order = 16, AuthorId = 9, GenreId = 5 },
            new Product { Id = 18, Name = "Компьютерные вирусы", Price = 900, ImageUrl = "harrypotter1.png", Message = "Книга о Гарри поттере первая из всего цикла рассказывает о фантастике.", Order = 17, AuthorId = 10, GenreId = 12 },
